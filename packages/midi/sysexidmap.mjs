// List of MIDI System Exclusive IDs
// Taken from https://midi.org/sysexidtable

export const sysexIdMap = {
  '0x00': '[Used for ID Extensions]',
  ...
  '0x00 0x02 0x3C': 'Copper and Cedar',
  '0x00 0x02 0x3D': 'Whirled Notes',
  '0x00 0x02 0x3E': 'Cejetvole, LLC',
  '0x00 0x02 0x3F': 'DAWn Audio LLC',
  '0x00 0x02 0x40': 'Space Brain Circuits',
  '0x00 0x02 0x41': 'Caedence',
  '0x00 0x02 0x42': 'HCN Designs, LLC (The MIDI Maker)',
  '0x00 0x02 0x43': 'PTZOptics',
  '0x00 0x02 0x44': 'Noise Engineering',
  '0x00 0x02 0x45': 'Synthesia LLC',
  '0x00 0x02 0x46': 'Jeff Whitehead Lutherie LLC',
  '0x00 0x02 0x47': 'Wampler Pedals Inc.',
  '0x00 0x02 0x48': 'Tapis Magique',
  '0x00 0x02 0x49': 'Leaf Secrets',
  '0x00 0x02 0x4A': 'Groove Synthesis',
  '0x00 0x02 0x4B': 'Audiocipher Technologies LLC',
  '0x00 0x02 0x4C': 'Mellotron Inc.',
  '0x00 0x02 0x4D': 'Hologram Electronics LLC',
  '0x00 0x02 0x4E': 'iCON Americas, LLC',
  '0x00 0x02 0x4F': 'Singular Sound',
  '0x00 0x02 0x50': 'Genovation Inc',
  '0x00 0x02 0x51': 'Method Red',
  '0x00 0x02 0x52': 'Brain Inventions',
  '0x00 0x02 0x53': 'Synervoz Communications Inc.',
  '0x00 0x02 0x54': 'Hypertriangle Inc',
  ...
  '0x00 0x21 0x5A': 'Cari Electronic',
  '0x00 0x21 0x5B': 'Oxi Electronic Instruments SL',
  '0x00 0x21 0x5C': 'XMPT',
  '0x00 0x21 0x5D': 'SHANGHAI HUAXIN MUSICAL INSTRUMENT',
  '0x00 0x21 0x5E': 'Shenzhen Huashi Technology Co., Ltd',
  '0x00 0x21 0x60': 'Guangzhou Rantion Technology Co., Ltd.',
  '0x00 0x21 0x61': 'Ryme Music',
  '0x00 0x21 0x62': 'GS Music',
  '0x00 0x21 0x63': 'Shenzhen Flamma Innovation Co., Ltd',
  '0x00 0x21 0x64': 'Shenzhen Mooer Audio Co.,LTD.',
  '0x00 0x21 0x65': 'Raw Material Software Limited (JUCE)',
  '0x00 0x21 0x66': 'Birdkids',
  '0x00 0x21 0x67': 'Beijing QianYinHuLian Tech. Co',
  '0x00 0x21 0x68': 'Nimikry Music OG',
  '0x00 0x21 0x69': 'Newzik',
  '0x00 0x21 0x6A': 'Hamburg Wave',
  '0x00 0x21 0x6B': 'Grimm Audio',
  '0x00 0x21 0x6C': 'Arcana Instruments LTD.',
  '0x00 0x21 0x6D': 'GameChanger Audio',
  '0x00 0x21 0x6E': 'OakTone',
  '0x00 0x21 0x6F': 'The Digi-Gurdy: A MIDI Hurdy Gurdy',
  '0x00 0x21 0x70': 'MusiKraken',
  '0x00 0x21 0x71': 'PhotoSynth > InterFACE',
  '0x00 0x21 0x72': 'Instruments of Things',
  '0x00 0x21 0x73': 'oodi',
  '0x00 0x21 0x74': 'Komires Sp. z o.o.',
  '0x00 0x21 0x75': 'Lehle GmbH',
  '0x00 0x21 0x76': 'Joué Music Instruments',
  '0x00 0x21 0x77': 'Guangzhou Pearl River Amason Digital Musical Instrument Co. Ltd',
